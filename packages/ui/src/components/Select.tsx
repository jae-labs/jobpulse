  ...
  ({ className, containerClassName, density = 'default', ...props }, ref) => (
    <div className={cn('group relative w-full', containerClassName)}>
      <select
        ref={ref}
          className={cn(
            'h-9 w-full appearance-none rounded-ds-control border border-ds-border-control bg-ds-control px-3 pr-10 text-ds-text-primary transition-colors hover:bg-ds-hover focus:border-ds-accent focus:outline-none ds-control-focus disabled:cursor-not-allowed disabled:opacity-50',
