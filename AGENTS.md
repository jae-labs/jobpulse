...
- If database tables, RLS, or schema change: create a migration (`npm run db:migration <name>`), push changes
  (`npm run db:push`), and regenerate types (`npm run db:types`).
