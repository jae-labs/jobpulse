      ...
      <div className="w-full max-w-[340px] flex flex-col items-center text-center">
        ...
        <p className="text-xs text-zinc-400 mb-6 leading-relaxed">
          {email ? (
            ...
            'Your profile is not authorized to access JobPulse.'
          )}
        </p>
        ...
        {error && (
          <div className="w-full text-left rounded-xl border border-amber-500/20 bg-amber-500/10 p-3.5 mb-6 text-xs space-y-1.5">
            ...
            <div className="text-zinc-400 leading-normal">
              The <code className="text-amber-200 bg-amber-950/60 px-1 py-0.5 rounded">authorized_users</code> table is not yet created in Supabase. Apply the database migrations in <code className="text-amber-200 bg-amber-950/60 px-1 py-0.5 rounded">supabase/migrations</code> via <code className="text-amber-200 bg-amber-950/60 px-1 py-0.5 rounded">npm run db:push</code>.
            </div>
          </div>
        )}
