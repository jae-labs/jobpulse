  ...
  return (
    <div className="relative min-h-dvh flex flex-col items-center justify-center px-4 bg-ds-canvas text-ds-text-primary selection:bg-ds-selected">
      <div className="w-full max-w-[340px] flex flex-col items-center text-center">
        ...
        {error && (
          <div className="w-full text-left rounded-xl border border-ds-warning/30 bg-ds-warning/10 p-3.5 mb-6 text-xs space-y-1.5">
            ...
            <div className="text-ds-text-muted leading-normal">
              <Trans i18nKey="auth.databaseSetupInstructions">
                The <code className="text-ds-warning bg-ds-warning/20 px-1 py-0.5 rounded">authorized_users</code> table is not yet created in Supabase. Apply the database migrations in <code className="text-ds-warning bg-ds-warning/20 px-1 py-0.5 rounded">supabase/migrations</code> via <code className="text-ds-warning bg-ds-warning/20 px-1 py-0.5 rounded">npm run db:push</code>.
              </Trans>
            </div>
          </div>
        )}
