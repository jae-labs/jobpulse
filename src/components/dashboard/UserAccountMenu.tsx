...
export const UserProfileMenu: React.FC<UserProfileMenuProps> = ({
  ...
  return (
    <div className="relative inline-flex items-center" ref={menuRef}>
      ...
      {isOpen && (
        <div className="absolute top-full right-0 mt-2 w-56 sm:w-60 rounded-xl border border-ds-border bg-ds-panel p-2 shadow-2xl z-50 text-xs text-ds-text-secondary animate-in fade-in-50 zoom-in-95 duration-100 divide-y divide-ds-border">
          {/* User Info Header */}
          ...
          <div className="py-1.5 space-y-0.5">
            <button
              ...
              className="flex w-full items-center gap-2.5 rounded-lg px-2.5 py-1.5 text-ds-text-secondary hover:bg-ds-control hover:text-ds-text-primary transition-colors cursor-pointer text-left"
            >
              <User className="size-3.5 text-ds-text-muted shrink-0" />
          ...
          <div className="pt-1.5">
            <button
              ...
              className="flex w-full items-center gap-2.5 rounded-lg px-2.5 py-1.5 text-ds-negative hover:bg-ds-negative/10 hover:text-ds-negative transition-colors cursor-pointer text-left"
            >
