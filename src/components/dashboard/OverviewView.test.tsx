...
describe('OverviewView', () => {
  ...
  it('triggers navigation when stat card is clicked', async () => {
    ...
    const totalOpportunitiesCard = (await screen.findByText('Tracked Opportunities')).closest('button');
  ...
  it('navigates to high-fit filter when high-fit card is clicked', async () => {
    ...
    const highFitCard = (await screen.findByText('High-Fit Matches')).closest('button');
