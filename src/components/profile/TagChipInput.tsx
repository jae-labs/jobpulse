...
> = {
  ...
  interviewing: {
    chip: 'border-status-interviewing/30 bg-status-interviewing/10 text-status-interviewing hover:border-status-interviewing/50',
  ...
  'status-new': {
    chip: 'border-status-new/30 bg-status-new/10 text-status-new hover:border-status-new/50',
    close: 'text-status-new/80 hover:text-ds-text-primary',
  },
};
